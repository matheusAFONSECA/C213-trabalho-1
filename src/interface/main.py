...
def main():
    ...
    initial_k, initial_theta, initial_tau = 29.056, 10.10, 47.50  # Valores iniciais para o gráfico da direita
    ...
    with col2:
        render_right_column(initial_k, initial_theta, initial_tau, tempo, degrau, amplitude_degrau, saida_motor)
